  ...
  return (
    <main style={{ padding: "0 50px" }}>
      ...
      <div className="grid grid-cols-3 grid-rows-3">
        <div className="rec rounded shadow-lg bg-white p-8 mt-3 mr-3">
        ...
        <div className="rec rounded shadow-lg bg-white p-8 mt-3 mr-3">
          ...
          <p>
            A restaurant that serves authentic Japanese - style soups and
            noodles, with a selection of fresh, homemade soups that changes
            daily.
          </p>
          <p>4.5/5</p>
        </div>
